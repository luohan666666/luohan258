...
Page({
  data: {
    ...
    arr3: [
      { id: 0, img: "../../img/food2.jpg", name: "五花肉石锅拌饭", num: "0", price: "51", message: "配米饭一份哦", message2: "月售330｜好评率100%", message3: [{ id: 0, value: "微辣" }, { id: 1, value: "中味" }, { id: 2, value: "不辣" }, { id: 3, value: "不味" },] },
